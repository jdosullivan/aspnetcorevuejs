...
using GroupClue.Models.AccountViewModels;
using GroupClue.Data.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                user.Claims.Add(new IdentityUserClaim<string> { ClaimType = OpenIdConnectConstants.Claims.Email, ClaimValue = user.Email });
                user.Claims.Add(new IdentityUserClaim<string> { ClaimType = OpenIdConnectConstants.Claims.Name, ClaimValue = user.Name });
        ...
        */
        ...
        public async Task<IActionResult> Userinfo()
        {
            ...
            claims[OpenIdConnectConstants.Claims.Name] = user.Name;
